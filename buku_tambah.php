            ...
            <form method="post" enctype="multipart/form-data" >
                <?php
                    if(isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,gambar,penulis,penerbit,tahun_terbit,deskripsi, link) values ('$id_kategori','$judul','$file','$penulis','$penerbit','$tahun_terbit','$deskripsi', '$link')");
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8"><input type="text" class="form-control" name="link"></div>
                </div>
                <div class="row">
