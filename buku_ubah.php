            ...
            <form method="post" enctype="multipart/form-data">
                <?php
                   ...
                   if(isset($_POST['submit'])) {
                       ...
                       $link = $_POST['link']; // Tambahkan pengambilan nilai link dari form
                   
                       // Periksa apakah ada file gambar yang diunggah
                       if(isset($_FILES['gambar']['name']) && $_FILES['gambar']['error'] == 0 && $_FILES['gambar']['size'] > 0) {
                       ...
                       // Query UPDATE dengan kondisi WHERE id_buku
                       $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', gambar='$file', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi', link='$link' WHERE id_buku=$id");
                ...
                <!-- Tambahkan kolom untuk link -->
                <div class="row mb-3">
                    <div class="col-md-2">Link</div>
                    <div class="col-md-8"><input type="text" value="<?php echo $data ['link'];?>" class="form-control" name="link"></div>
                </div>
                <div class="row">
